...
public class userController {
    ...
    public commonResult<user> createUser(@RequestBody user user){
        ...
        userList.add(user);
        return new commonResult(200,"createSuccess11000",user);
    }
    ...
    public commonResult<user> getUserById(@PathVariable Integer userId){
        ...
        return new commonResult(200,"getSuccess11000",user);
    }
    ...
    public commonResult<user> getUserById2(@PathVariable String userName){
        return new commonResult(200,"getSuccess11000",new user(1111,userName,20,"123456"));
    }
}
